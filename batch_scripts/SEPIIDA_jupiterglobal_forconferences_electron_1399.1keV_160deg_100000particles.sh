...
./SEPIIDA 100000 e- 1399.1 160 -magnetic_model jrm33 -atmosphere_filename jupiter_gram.csv -injection_altitude 990.0 -backscatter_altitude 991.0 -brem_splitting 1000 -min_energy_eV 10 -lat 85 -cache_radius_km 1.0 -prefix jupiterglobal_forconferences
