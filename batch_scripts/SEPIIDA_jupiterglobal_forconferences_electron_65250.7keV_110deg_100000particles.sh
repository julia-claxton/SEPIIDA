...
./SEPIIDA 100000 e- 65250.7 110 -magnetic_model jrm33 -atmosphere_filename jupiter_gram.csv -injection_altitude 990.0 -backscatter_altitude 991.0 -brem_splitting 1000 -min_energy_eV 10 -lat 85 -cache_radius_km 1.0 -prefix jupiterglobal_forconferences

# Copy results to safe folder
cp /projects/jucl6426/SEPIIDA/build/results/jupiterglobal_forconferences*electron_input*65250.7keV_110deg_100000particles* /projects/jucl6426/SEPIIDA/results
set +x
