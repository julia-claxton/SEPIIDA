...
#SBATCH --job-name SEPIIDA_jlc_electron_1000.0keV_103deg_1000particles
#SBATCH --nodes 1
#SBATCH --ntasks-per-node 40
#SBATCH --time 1-00:00:00
#SBATCH --output /projects/jucl6426/SEPIIDA/results/SEPIIDA_jlc_electron_1000.0keV_103deg_1000particles.log
