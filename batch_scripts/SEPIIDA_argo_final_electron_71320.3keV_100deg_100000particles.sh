...
./SEPIIDA 100000 e- 71320.3 100 -magnetic_model jrm33 -atmosphere_filename ARGO_Jupiter.csv -injection_altitude 500.0 -backscatter_altitude 501.0 -brem_splitting 200 -min_energy_eV 1000 -lat 85 -cache_radius_km 1.0 -prefix argo_final
