...
#SBATCH --job-name SEPIIDA_gamma_variation_lat60_electron_1000.0keV_90.0deg_100000particles
#SBATCH --nodes 1
#SBATCH --ntasks-per-node 40
#SBATCH --time 1-00:00:00
#SBATCH --output /projects/jucl6426/SEPIIDA/results/SEPIIDA_gamma_variation_lat60_electron_1000.0keV_90.0deg_100000particles.log
