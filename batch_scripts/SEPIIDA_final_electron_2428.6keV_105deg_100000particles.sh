...
#SBATCH --job-name SEPIIDA_final_electron_2428.6keV_105deg_100000particles
#SBATCH --nodes 1
#SBATCH --ntasks-per-node 40
#SBATCH --time 1-00:00:00
#SBATCH --output /projects/jucl6426/SEPIIDA/results/SEPIIDA_final_electron_2428.6keV_105deg_100000particles.log
