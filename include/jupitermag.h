// Source: https://github.com/mattkjames7/libjupitermag
...
//    #define M_PI 3.14159265358979323846 // But not for me. Goodbye, Evelyn.
...
*
***************************************************************/
inline double FluxCan(	double rho,double z, double r0, double r1,
				double mui2, double D, 
				double deltarho, double deltaz) {
...
*
***************************************************************/
inline double FluxDip(double r, double theta, double g) {
